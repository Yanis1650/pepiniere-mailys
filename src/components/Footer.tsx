...
export default function Footer() {
  return (
    <footer className="bg-amber-50 border-t-2 border-orange-200">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Informations de contact */}
          <div>
                          <h3 className="text-lg font-semibold text-gray-800 mb-4">MAISON MAE</h3>
            <div className="space-y-2 text-gray-600">
              <p>📍 Adresse de la pépinière</p>
              <p>📞 Téléphone: 01 23 45 67 89</p>
              <p>✉️ Email: contact@pepiniere-mailys.fr</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/galerie" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Galerie
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © 2024 MAISON MAE FLORICULTURE. Tous droits réservés.
            </p>
